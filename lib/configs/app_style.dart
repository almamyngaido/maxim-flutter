...
class AppStyle {
  ...
  static TextStyle heading7Bold({required Color color}) {
    return _baseStyle(AppSize.appSize10, FontWeight.w700, AppFont.interBold)
        .copyWith(
      color: color,
    );
  }

  static TextStyle heading7Medium({required Color color}) {
    return _baseStyle(AppSize.appSize10, FontWeight.w500, AppFont.interMedium)
        .copyWith(
      color: color,
    );
  }
  ...
  static TextStyle heading8Regular({required Color color}) {
    return _baseStyle(AppSize.appSize8, FontWeight.w400, AppFont.interRegular)
        .copyWith(
      color: color,
    );
  }
